...
class Event extends Model
{
    ...
    {
		return $this->belongsToMany(EventCategory::class, 'category_event', 'event_id', 'category_id')->withTimestamps();
    }
	...
	{
		if($this->status == 1) {
			return '<a href="'.route('events.updatestatus', $this->id).'"><span class="label label-success">Public</span></a>';
		} else {
			return '<a href="'.route('events.updatestatus', $this->id).'"><span class="label label-danger">Hidden</span></a>';
		}
	}
}
